...
# --- Materials ---
uniaxialMaterial('Concrete01', 1, 25000000.0, 0.004, 5000000.0, 0.014)
...
# --- PUSHOVER ANALYSIS (Node 4, Dmax = 0.8, Distribución Modal)---
pattern('Plain', 2, 1)

# --- Analysis Modal ---
eigen(1)
load(2, 0.28020068561263173, 0.0, 0.0)
load(3, 0.7116105188506056, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
integrator('DisplacementControl', 4, 1, 0.008)
