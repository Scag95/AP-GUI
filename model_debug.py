...
# --- PUSHOVER ANALYSIS (Node 4, Dmax = 0.22999999999999998, Distribución Modal)---
timeSeries('Linear', 200)
pattern('Plain', 200, 200)
load(2, 0.2551575431899874, 0.0, 0.0)
load(3, 0.6880261563382785, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
integrator('DisplacementControl', 4, 1, 0.0023)
...
# --- PUSHOVER ANALYSIS (Node 4, Dmax = 0.22999999999999998, Distribución Modal)---
timeSeries('Linear', 205)
pattern('Plain', 205, 205)
load(2, 0.2551575431899874, 0.0, 0.0)
load(3, 0.6880261563382785, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
integrator('DisplacementControl', 4, 1, 0.0023)
...
# --- PUSHOVER ANALYSIS (Node 4, Dmax = 0.22999999999999998, Distribución Modal)---
timeSeries('Linear', 206)
pattern('Plain', 206, 206)
load(2, 0.2551575431899874, 0.0, 0.0)
load(3, 0.6880261563382785, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
integrator('DisplacementControl', 4, 1, 0.0023)
...
# --- PUSHOVER ANALYSIS (Node 4, Dmax = 0.22999999999999998, Distribución Modal)---
timeSeries('Linear', 207)
pattern('Plain', 207, 207)
load(2, 0.2551575431899874, 0.0, 0.0)
load(3, 0.6880261563382785, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
integrator('DisplacementControl', 4, 1, 0.0023)
...
# --- PUSHOVER ANALYSIS (Node 4, Dmax = 0.22999999999999998, Distribución Modal)---
timeSeries('Linear', 208)
pattern('Plain', 208, 208)
load(2, 0.2551575431899874, 0.0, 0.0)
load(3, 0.6880261563382785, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
integrator('DisplacementControl', 4, 1, 0.0023)
...
# --- PUSHOVER ANALYSIS (Node 4, Dmax = 0.22999999999999998, Distribución Modal)---
timeSeries('Linear', 209)
pattern('Plain', 209, 209)
load(2, 0.2551575431899874, 0.0, 0.0)
load(3, 0.6880261563382785, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
integrator('DisplacementControl', 4, 1, 0.0023)
