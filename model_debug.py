...
timeSeries('Linear', 1)
pattern('Plain', 1, 1)
eleLoad('-ele', 1, '-type', '-beamUniform', -0.0, -3924.000000000001)
eleLoad('-ele', 2, '-type', '-beamUniform', -0.0, -3924.000000000001)
eleLoad('-ele', 3, '-type', '-beamUniform', -0.0, -3924.000000000001)
eleLoad('-ele', 4, '-type', '-beamUniform', -0.0, -3924.000000000001)
eleLoad('-ele', 5, '-type', '-beamUniform', -0.0, -3924.000000000001)
eleLoad('-ele', 6, '-type', '-beamUniform', -0.0, -3924.000000000001)
...
load(2, 0.45345292980321245, 0.0, 0.0)
load(3, 1.2717126577264335, 0.0, 0.0)
load(4, 1.0, 0.0, 0.0)
wipeAnalysis()
system('UmfPack')
numberer('RCM')
...
analysis('Static')
uniaxialMaterial('Elastic', 999999, 10000000000.0)
node(2000040, 0.0, 10.5)
fix(2000040, 1, 1, 1)
element('zeroLength', 3000040, 2000040, 4, '-mat', 999999, '-dir', 1)
node(2000080, 3.0, 10.5)
fix(2000080, 1, 1, 1)
element('zeroLength', 3000080, 2000080, 8, '-mat', 999999, '-dir', 1)
